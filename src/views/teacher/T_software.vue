  ...
  <div>
    <div>
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>软件正版化</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="ios" label="操作系统" width="100">
        </el-table-column>
        <el-table-column prop="office" label="Office" width="100">
        </el-table-column>
        <el-table-column prop="time" label="安装时间" width="120">
        </el-table-column>
        <el-table-column prop="address" label="安装地点" width="100">
        </el-table-column>
...
export default {
  ...
  methods: {
    // 查询信息
    async selectmessage() {
      const { data: res } = await this.$http.get("/teacher/software");
    ...
    exportToExcel() {
      require.ensure([], () => {
        ...
        export_json_to_excel(tHeader, data, "软件正版化申请服务列表");
      });
    },
